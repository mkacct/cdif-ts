// tests each of the primitive value classes (primitive-value.ts)
...
suite("v1 CDIFPrimitiveValue", (): void => {
	...
	suite("character", (): void => {

		test("characters", (): void => {
